...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  return _react2.default.createElement(
    ...
    giphys.map(function (giphy) {
      return _react2.default.createElement(_giphys_index_item2.default, { giphy: giphy, key: giphy.id });
    })
  );
};
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      var _props = this.props,
          giphys = _props.giphys,
          fetchSearchGiphys = _props.fetchSearchGiphys;

      e.preventDefault();
      fetchSearchGiphys(this.state.searchTerm).then(function (res) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', value: this.state.searchTerm, onChange: this.handleChange }),
